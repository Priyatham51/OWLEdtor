...
public class addingAcxiom {
    ...
    public static void main(String[] args) {
        try {
            ...
            OWLAxiom axiom = factory.getOWLSubClassOfAxiom(clsB, owlThing);
            //OWLAxiom axiom = factory.getOWLClassAssertionAxiom(clsB, null)
